        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4">
            <DropdownInput
              ...
              {...register('organizationType', {
                required: !isEditMode && 'Organization Type is required',
              })}
            ...
            <DropdownInput
              ...
              classname="w-80"
              {...register('rateVat', {
                required: !isEditMode && 'Rate VAT is required',
              })}
          ...
          <div className="grid grid-cols-1 gap-4">
            <Input
              ...
              classname="w-80"
              {...register('inn', {
                required: !isEditMode && 'Inn is required',
              })}
              value={formData.inn}
            ...
            <Input
              ...
              classname="w-80"
              {...register('fullName', {
                required: !isEditMode && 'Full Name is required',
              })}
            ...
            <Input
              ...
              classname="w-80"
              {...register('okpo', {
                required: !isEditMode && 'Okpo is required',
              })}
              value={formData.okpo}
          ...
          <MultilineInput
            ...
            {...register('addressRegistration', {
              required: !isEditMode && 'Registration Address is required',
            })}
          ...
          <Input
            ...
            classname="w-80"
            {...register('ogrn', {
              required: !isEditMode && 'OGRN is required',
            })}
            value={formData.ogrn}
          ...
          <div className="grid grid-cols-1 gap-4">
            <Input
              ...
              classname="w-80"
              {...register('bik', {
                required: !isEditMode && 'BIK is required',
              })}
              value={formData.bik}
            ...
            <Input
              ...
              {...register('correspondentAccount', {
                required: !isEditMode && 'Correspondent Account is required',
              })}
            ...
            <Input
              ...
              classname="w-80"
              {...register('bank', {
                required: !isEditMode && 'Bank is required',
              })}
              value={formData.bank}
            ...
            <Input
              ...
              {...register('settlementAccount', {
                required: !isEditMode && 'Settlement Account is required',
              })}
          ...
          <MultilineInput
            ...
            {...register('addressBank', {
              required: !isEditMode && 'Bank Address is required',
            })}
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-4 mt-6">
            ...
            <Button
              ...
              form={true}
              isLoading={isEditMode ? updatingOrganization : isMutating}
              handleClick={() => {}}
            />
          </div>
        </form>
