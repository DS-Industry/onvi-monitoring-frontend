...
type TechTaskFormProps = {
  techTaskToEdit: TechTaskManagerInfo;
  techTaskId: number;
  onEdit: () => void;
  isOpen: boolean;
  onClose: () => void;
      ...
      >
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <Input
            ...
            error={!!errors.name}
            {...register('name', {
              required: techTaskId === 0 && 'Name is required',
            })}
          ...
          <DropdownInput
            ...
            classname="w-64"
            {...register('posId', {
              required: techTaskId === 0 && 'Pos ID is required',
              validate: value =>
                value !== 0 || techTaskId !== 0 || 'Pos ID is required',
            })}
          ...
          <DropdownInput
            ...
            {...register('type', {
              required: techTaskId === 0 && 'Type is required',
            })}
            value={formData.type}
          ...
          <DateInput
            ...
            {...register('startDate', {
              required: techTaskId === 0 && 'Start Date is required',
            })}
            helperText={errors.startDate?.message || ''}
            disabled={techTaskId !== 0}
          />
          <div>
          ...
          <div className="flex justify-start space-x-4">
            ...
            <Button
              ...
              form={true}
              isLoading={techTaskId !== 0 ? updatingTechTask : isMutating}
            />
          </div>
        </form>
      </Drawer>
