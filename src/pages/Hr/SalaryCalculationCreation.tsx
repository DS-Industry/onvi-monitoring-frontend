                ...
                <div className="mt-8 space-y-5 shadow-card rounded-2xl p-5">
                    ...
                    <DynamicTable
                        data={paymentsData.map((item, index) => ({
                            ...
                            sum: item.monthlySalary + item.dailySalary * (item.prepaymentCountShifts + item.countShifts) - item.prepaymentSum + item.prize - item.fine,
                            totalPayment: item.prepaymentSum + item.monthlySalary + item.dailySalary * (item.prepaymentCountShifts + item.countShifts) - item.prepaymentSum + item.prize - item.fine
                        }))}
