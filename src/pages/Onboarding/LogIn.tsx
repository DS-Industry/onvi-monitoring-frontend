    ...
    <div className="flex min-h-screen items-center justify-center bg-background02 p-4">
      <div className="flex flex-col rounded-lg p-8 lg:flex-row md:p-0">
        <div className="lg:w-5/12 p-8 lg:ml-40">
          ...
          <h1 className="text-2xl font-extrabold leading-[1.25] text-text01 mb-2">{t('С возвращением в Onvi-бизнес!')}</h1>
          <p className="text-text01 mb-6">{t('Мы рады видеть вас снова! Введите адрес электронной почты и пароль.')}</p>
