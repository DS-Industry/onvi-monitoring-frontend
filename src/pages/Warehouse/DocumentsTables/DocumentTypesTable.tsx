...
interface EditableCellProps {
    ...
    onChange: (id: number, dataIndex: string, value: string | boolean | number) => void;
}
...
const EditableCell: React.FC<EditableCellProps> = ({
    ...
    const value = record?.[dataIndex] ?? (inputType === "checkbox" ? false : inputType === "number" ? 0 : "");
...
const DocumentTypesTable: React.FC<Props> = ({
    ...
    const handleChange = (id: number, dataIndex: string, value: string | number | boolean) => {
                        ...
                        return {
                            ...
                            deviation:
                                dataIndex === "quantity" || dataIndex === "oldQuantity"
                                    ...
                                    (dataIndex === "oldQuantity" ? Number(value) : item.oldQuantity ?? 0)
                                    : item.deviation
                        };
                    }
                ...
                <div className="w-full overflow-x-auto">
                    <Table
                        ...
                        components={{
                            ...
                            header: {
                                cell: (props: JSX.IntrinsicAttributes & React.ClassAttributes<HTMLTableHeaderCellElement> & React.ThHTMLAttributes<HTMLTableHeaderCellElement>) => (
                                    <th
                                        {...props}
                                        style={{
