...
const Clients: React.FC = () => {
  ...
  useEffect(() => {
    if (!loadingClients && clientsData) setTotalCount(clientsData.length);
      ...
      {loadingClients || isTableLoading ? (
        ...
        <div className="mt-8 flex flex-col min-h-screen">
          <DynamicTable
            ...
            onEdit={handleUpdate}
            navigableFields={[
              { key: 'name', getPath: () => '/marketing/clients/profile' },
            ]}
            showPagination={true}
          />
        ...
        <div className="flex flex-col justify-center items-center">
          <NoDataUI title={t('marketing.noClient')} description={''}>
            <img
              src={ClientEmpty}
              className="mx-auto"
              loading="lazy"
