...
const BasicInformation: React.FC = () => {
    ...
    const { data: clientData, isValidating: loadingClients } = useSWR(editClientId !== 0 ? [`get-client-by-id`] : null, () => getClientById(editClientId), { revalidateOnFocus: false, revalidateOnReconnect: false, keepPreviousData: true });
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-5">
                    ...
                    <div className="flex flex-col space-y-6 w-full">
                        ...
                        <div className="flex flex-col space-y-2">
                            <Skeleton.Input active style={{ width: 100, height: 24, marginBottom: 8 }} />
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="flex gap-2 flex-wrap">
                                {Array.from({ length: 3 }).map((_, i) => (
                                    <Skeleton.Button key={i} active size="small" style={{ width: 80, height: 32 }} />
                                ))}
                            </div>
                        </div>
