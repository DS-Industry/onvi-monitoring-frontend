...
export async function createWorker(
  ...
  const response: AxiosResponse<TWorker> = await api.post(
    HR.GET_WORKERS,
    formData,
    {
      headers: {
...
export async function updateWorker(
  ...
  const response: AxiosResponse<TWorker> = await api.patch(
    HR.GET_WORKERS,
    formData,
    {
      headers: {
...
export async function createPosition(
  ...
  const response: AxiosResponse<PositionResponse> = await api.post(
    HR.GET_POSITIONS,
    body
  );
  return response.data;
...
export async function updatePosition(
  ...
  const response: AxiosResponse<PositionResponse> = await api.patch(
    HR.GET_POSITIONS,
    body
  );
  return response.data;
...
export async function calculatePrepayment(
  body: PrepaymentCalculateBody
): Promise<PrepaymentCalculateResponse[]> {
  const response: AxiosResponse<PrepaymentCalculateResponse[]> = await api.post(
    HR.PREPAYMENT + '/calculate',
    body
  );
  return response.data;
}
...
export async function createPrepayment(
  body: PrepaymentCreateRequest
): Promise<PrepaymentCreateResponse> {
...
export async function getPrepayments(
  ...
  const response: AxiosResponse<PrepaymentResponse[]> = await api.get(
    HR.PREPAYMENT + 's',
    { params }
  );
...
export async function calculatePayment(
  ...
  const response: AxiosResponse<PaymentCalculateResponse[]> = await api.post(
    HR.PAYMENT + '/calculate',
    body
  );
  return response.data;
}
...
export async function getPayments(
  ...
  const response: AxiosResponse<PaymentsResponse[]> = await api.get(
    HR.PAYMENT + 's',
    { params }
  );
...
export async function addWorkerPrePayment(
  body: addWorkerRequest
): Promise<PrepaymentCalculateResponse[]> {
  const response: AxiosResponse<PrepaymentCalculateResponse[]> = await api.post(
    HR.PREPAYMENT + '/calculate/workers',
    body
  );
  return response.data;
}
