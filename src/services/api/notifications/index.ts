...
export async function updateTag(body: UpdateTagRequest): Promise<TagResponse> {
  const response: AxiosResponse<TagResponse> = await api.patch(
    NOTIFICATION.GET_NOTIFS + '/tag',
    body
  );
  return response.data;
...
export async function deleteTag(id: number): Promise<ReadNotifsResponse> {
  const response: AxiosResponse<ReadNotifsResponse> = await api.delete(
    NOTIFICATION.GET_NOTIFS + '/tag' + `/${id}`
  );
  return response.data;
}
...
export async function getNotifications(
  params: GetUserNotifParams
): Promise<UserNotificationResponse[]> {
  const response: AxiosResponse<UserNotificationResponse[]> = await api.get(
    NOTIFICATION.GET_NOTIFS + '/user-notification',
    { params }
  );
  return response.data;
}
...
export async function updateNotifications(
  body: UpdateNotifRequest
): Promise<UserNotificationResponse> {
  const response: AxiosResponse<UserNotificationResponse> = await api.patch(
    NOTIFICATION.GET_NOTIFS + '/user-notification',
    body
  );
  return response.data;
...
export async function readNotifications(): Promise<ReadNotifsResponse> {
  const response: AxiosResponse<ReadNotifsResponse> = await api.patch(
    NOTIFICATION.GET_NOTIFS + '/read-all'
  );
  return response.data;
}
