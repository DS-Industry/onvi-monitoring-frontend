    ...
    subNav: [
      ...
      { name: "abcd", filter: false, addButton: false, addButtonText: "add", isVisible: true, path: "/finance/timesheet/view", component: TimesheetView, permissions: [{ action: "manage", subject: "CashCollection" }, { action: "read", subject: "CashCollection" }, { action: "create", subject: "CashCollection" }, { action: "update", subject: "CashCollection" }, { action: "delete", subject: "CashCollection" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false },
      {
        name: "financial", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/financial/accounting", component: Default, permissions: [{ action: "manage", subject: "CashCollection" }, { action: "read", subject: "CashCollection" }, { action: "create", subject: "CashCollection" }, { action: "update", subject: "CashCollection" }, { action: "delete", subject: "CashCollection" }], isSidebar: true, isHr: true, titleName: "", subNav: [
          ...
          { name: "direct", filter: false, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/financial/accounting/directory/articles", component: DirectoryArticles, permissions: [{ action: "manage", subject: "CashCollection" }, { action: "read", subject: "CashCollection" }, { action: "create", subject: "CashCollection" }, { action: "update", subject: "CashCollection" }, { action: "delete", subject: "CashCollection" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      ...
      { name: "reportFor", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/report/period", component: MonthlyExpanse, permissions: [{ action: "manage", subject: "CashCollection" }, { action: "read", subject: "CashCollection" }, { action: "create", subject: "CashCollection" }, { action: "update", subject: "CashCollection" }, { action: "delete", subject: "CashCollection" }], isSidebar: true, isHr: false, titleName: "from", subNav: [], subMenu: false },
      { name: "reportFor", filter: false, addButton: false, addButtonText: "add", isVisible: true, path: "/finance/report/period/edit", component: MonthlyExpanseEdit, permissions: [{ action: "manage", subject: "CashCollection" }, { action: "read", subject: "CashCollection" }, { action: "create", subject: "CashCollection" }, { action: "update", subject: "CashCollection" }, { action: "delete", subject: "CashCollection" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false },
    ]
  },
  {
    name: "analysis",
