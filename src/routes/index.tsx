...
const routes = [
    ...
    subNav: [
      ...
      { name: "abcd", filter: false, addButton: false, addButtonText: "add", isVisible: true, path: "/finance/timesheet/view", component: TimesheetView, permissions: [{ action: "manage", subject: "ShiftReport" }, { action: "read", subject: "ShiftReport" }, { action: "create", subject: "ShiftReport" }, { action: "update", subject: "ShiftReport" }, { action: "delete", subject: "ShiftReport" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false },
      {
        name: "financial", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/financial/accounting", component: Default, permissions: [{ action: "manage", subject: "ManagerPaper" }, { action: "read", subject: "ManagerPaper" }, { action: "create", subject: "ManagerPaper" }, { action: "update", subject: "ManagerPaper" }, { action: "delete", subject: "ManagerPaper" }], isSidebar: true, isHr: true, titleName: "", subNav: [
          ...
          { name: "appointment", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/financial/accounting/directory/appointments", component: Default, permissions: [{ action: "hide", subject: "ManagerPaper" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false }
        ], subMenu: true
      },
  ...
  },
  {
    ...
    subNav: [
      ...
      {
        name: "technicalTasks", filter: true, addButton: true, addButtonText: "create", isVisible: true, path: "/equipment/technical/tasks", component: RoutineWork, permissions: [{ action: "manage", subject: "TechTask" }, { action: "create", subject: "TechTask" }, { action: "read", subject: "TechTask" }, { action: "update", subject: "TechTask" }, { action: "delete", subject: "TechTask" }], isSidebar: true, subNav: [
          { name: "list", filter: true, addButton: false, addButtonText: "create", isVisible: true, path: "/equipment/technical/tasks/list", component: RoutineWork, permissions: [{ action: "manage", subject: "TechTask" }, { action: "create", subject: "TechTask" }, { action: "read", subject: "TechTask" }, { action: "update", subject: "TechTask" }, { action: "delete", subject: "TechTask" }], isSidebar: true },
          { name: "list", filter: false, addButton: false, addButtonText: "create", isVisible: true, path: "/equipment/technical/tasks/list/item", component: RoutineWorkItem, permissions: [{ action: "manage", subject: "TechTask" }, { action: "create", subject: "TechTask" }, { action: "read", subject: "TechTask" }, { action: "update", subject: "TechTask" }, { action: "delete", subject: "TechTask" }], isSidebar: false },
          { name: "progress", filter: true, addButton: false, addButtonText: "create", isVisible: true, path: "/equipment/technical/tasks/progress", component: ProgressReport, permissions: [{ action: "manage", subject: "TechTask" }, { action: "create", subject: "TechTask" }, { action: "read", subject: "TechTask" }, { action: "update", subject: "TechTask" }, { action: "delete", subject: "TechTask" }], isSidebar: true },
          { name: "progress", filter: false, addButton: false, addButtonText: "create", isVisible: true, path: "/equipment/technical/tasks/progress/item", component: ProgressReportItem, permissions: [{ action: "manage", subject: "TechTask" }, { action: "create", subject: "TechTask" }, { action: "read", subject: "TechTask" }, { action: "update", subject: "TechTask" }, { action: "delete", subject: "TechTask" }], isSidebar: false },
