...
const routes = [
  ...
  },
  {
    ...
    subNav: [
      { name: "subscriptions", filter: false, addButton: false, addButtonText: '', isVisible: true, path: "/administration/subscriptions", component: Subscriptions, permissions: [{ action: "manage", subject: "Organization" }, { action: "create", subject: "Organization" }, { action: "read", subject: "Organization" }, { action: "update", subject: "Organization" }, { action: "delete", subject: "Organization" },{ action: "manage", subject: "Pos" }, { action: "create", subject: "Pos" }, { action: "read", subject: "Pos" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      {
        name: "accessRights", filter: false, addButton: false, addButtonText: '', isVisible: true, path: "/administration/accessRights", component: Default, permissions: [{ action: "manage", subject: "Organization" }, { action: "update", subject: "Organization" }, { action: "read", subject: "Organization" }], isSidebar: true, isHr: false, titleName: "", subNav: [
          { name: "listOf", filter: false, addButton: true, addButtonText: 'add', isVisible: true, path: "/administration/accessRights/employees", component: ListOfEmployees, permissions: [{ action: "manage", subject: "Organization" }, { action: "update", subject: "Organization" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
          { name: "listRoles", filter: false, addButton: false, addButtonText: 'addR', isVisible: true, path: "/administration/accessRights/roles", component: ListOfRoles, permissions: [{ action: "manage", subject: "Organization" }, { action: "read", subject: "Organization" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
          { name: "pos", filter: false, addButton: false, addButtonText: 'addR', isVisible: true, path: "/administration/accessRights/pos/connection", component: PosConnection, permissions: [{ action: "manage", subject: "Organization" }, { action: "update", subject: "Organization" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false }
        ], subMenu: true
      },
      { name: "legalEntities", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/administration/legalRights", component: Organization, permissions: [{ action: "manage", subject: "Organization" }, { action: "create", subject: "Organization" }, { action: "read", subject: "Organization" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "objectManagement", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/administration/objectManagement", component: Pos, permissions: [{ action: "manage", subject: "Pos" }, { action: "create", subject: "Pos" }, { action: "read", subject: "Pos" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
    ],
    isSidebar: true
  },
  {
  ...
  },
  {
    ...
    component: Default,
    isSidebar: true,
    permissions: [{ action: "manage", subject: "Hr" }, { action: "create", subject: "Hr" }, { action: "read", subject: "Hr" }, { action: "update", subject: "Hr" }],
    subNavHeading: "",
    subNav: [
      { name: "employees", filter: true, addButton: true, addButtonText: "addE", isVisible: true, path: "/hr/employees", component: Employees, permissions: [{ action: "manage", subject: "Hr" }, { action: "read", subject: "Hr" }, { action: "update", subject: "Hr" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "sid", filter: false, addButton: true, addButtonText: "save", isVisible: true, path: "/hr/employees/profile", component: EmployeeProfile, permissions: [{ action: "manage", subject: "Hr" }, { action: "create", subject: "Hr" }, { action: "read", subject: "Hr" }, { action: "update", subject: "Hr" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "positions", filter: false, addButton: true, addButtonText: "new", isVisible: true, path: "/hr/positions", component: Positions, permissions: [{ action: "manage", subject: "Hr" }, { action: "read", subject: "Hr" }, { action: "update", subject: "Hr" }], isSidebar: true, isHr: true, titleName: "", subNav: [], subMenu: false },
      { name: "salary", filter: true, addButton: true, addButtonText: "calc", isVisible: true, path: "/hr/salary", component: SalaryCalculation, permissions: [{ action: "manage", subject: "Hr" }, { action: "create", subject: "Hr" }, { action: "read", subject: "Hr" }], isSidebar: true, isHr: false, titleName: "reports", subNav: [], subMenu: false },
      { name: "sal", filter: false, addButton: false, addButtonText: "calc", isVisible: true, path: "/hr/salary/creation", component: SalaryCalculationCreation, permissions: [{ action: "manage", subject: "Hr" }, { action: "create", subject: "Hr" }, { action: "read", subject: "Hr" }, { action: "update", subject: "Hr" }], isSidebar: false, isHr: false, titleName: "reports", subNav: [], subMenu: false },
      { name: "empAdv", filter: true, addButton: true, addButtonText: "create", isVisible: true, path: "/hr/employee/advance", component: EmployeeAdvance, permissions: [{ action: "manage", subject: "Hr" }, { action: "create", subject: "Hr" }, { action: "read", subject: "Hr" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "empAdv", filter: false, addButton: true, addButtonText: "create", isVisible: true, path: "/hr/employee/advance/creation", component: EmployeeAdvanceCreation, permissions: [{ action: "manage", subject: "Hr" }, { action: "create", subject: "Hr" }, { action: "read", subject: "Hr" }, { action: "update", subject: "Hr" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false }
    ]
  },
  {
    name: "finance",
    ...
    subNavHeading: "",
    subNav: [
      { name: "collection", filter: true, addButton: true, addButtonText: "create", isVisible: true, path: "/finance/collection", component: Collection, permissions: [{ action: "manage", subject: "CashCollection" }, { action: "read", subject: "CashCollection" }, { action: "create", subject: "CashCollection" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "collection", filter: false, addButton: false, addButtonText: "create", isVisible: true, path: "/finance/collection/creation", component: CollectionCreation, permissions: [{ action: "manage", subject: "CashCollection" }, { action: "read", subject: "CashCollection" }, { action: "create", subject: "CashCollection" }, { action: "update", subject: "CashCollection" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "timestamp", filter: false, addButton: false, addButtonText: "create", isVisible: true, path: "/finance/timestamp", component: Timestamps, permissions: [{ action: "manage", subject: "CashCollection" }, { action: "read", subject: "CashCollection" }, { action: "create", subject: "CashCollection" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      ...
      { name: "employee", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/timesheet", component: Timesheet, permissions: [{ action: "manage", subject: "ShiftReport" }, { action: "read", subject: "ShiftReport" }, { action: "create", subject: "ShiftReport" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "employee", filter: false, addButton: false, addButtonText: "add", isVisible: true, path: "/finance/timesheet/creation", component: TimesheetCreation, permissions: [{ action: "manage", subject: "ShiftReport" }, { action: "read", subject: "ShiftReport" }, { action: "create", subject: "ShiftReport" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "abcd", filter: false, addButton: false, addButtonText: "add", isVisible: true, path: "/finance/timesheet/view", component: TimesheetView, permissions: [{ action: "manage", subject: "ShiftReport" }, { action: "read", subject: "ShiftReport" }, { action: "create", subject: "ShiftReport" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false },
      {
        name: "financial", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/financial/accounting", component: Default, permissions: [{ action: "manage", subject: "ManagerPaper" }, { action: "read", subject: "ManagerPaper" }, { action: "create", subject: "ManagerPaper" }, { action: "update", subject: "ManagerPaper" }, { action: "delete", subject: "ManagerPaper" }], isSidebar: true, isHr: true, titleName: "", subNav: [
          ...
          { name: "direct", filter: false, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/financial/accounting/directory/articles", component: DirectoryArticles, permissions: [{ action: "manage", subject: "ManagerPaper" }, { action: "read", subject: "ManagerPaper" }, { action: "update", subject: "ManagerPaper" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      ...
      { name: "reportFor", filter: true, addButton: true, addButtonText: "add", isVisible: true, path: "/finance/report/period", component: MonthlyExpanse, permissions: [{ action: "manage", subject: "ManagerPaper" }, { action: "read", subject: "ManagerPaper" }, { action: "create", subject: "ManagerPaper" }, { action: "delete", subject: "ManagerPaper" }], isSidebar: true, isHr: false, titleName: "", subNav: [], subMenu: false },
      { name: "reportFor", filter: false, addButton: false, addButtonText: "add", isVisible: true, path: "/finance/report/period/edit", component: MonthlyExpanseEdit, permissions: [{ action: "manage", subject: "ManagerPaper" }, { action: "read", subject: "ManagerPaper" }, { action: "create", subject: "ManagerPaper" }, { action: "delete", subject: "ManagerPaper" }], isSidebar: false, isHr: false, titleName: "", subNav: [], subMenu: false },
    ]
  },
  {
    name: "analysis",
  ...
  },
  {
    ...
    subNav: [
      ...
      { name: "chemical", filter: true, addButton: false, addButtonText: "report", isVisible: true, path: "/equipment/chemical/consumption", component: ChemicalConsumption, permissions: [{ action: "manage", subject: "Incident" }, { action: "read", subject: "Incident" }], isSidebar: true, subNav: [], subMenu: false },
      {
        name: "routine", filter: true, addButton: true, addButtonText: "create", isVisible: true, path: "/equipment/routine/work", component: RoutineWork, permissions: [{ action: "manage", subject: "TechTask" }, { action: "create", subject: "TechTask" }, { action: "read", subject: "TechTask" }, { action: "update", subject: "TechTask" }, { action: "delete", subject: "TechTask" }], isSidebar: true, subNav: [
          ...
          { name: "progress", filter: true, addButton: false, addButtonText: "create", isVisible: true, path: "/equipment/routine/work/progress", component: ProgressReport, permissions: [{ action: "manage", subject: "TechTask" }, { action: "read", subject: "TechTask" }], isSidebar: true },
          { name: "progress", filter: false, addButton: false, addButtonText: "create", isVisible: true, path: "/equipment/routine/work/progress/item", component: ProgressReportItem, permissions: [{ action: "manage", subject: "TechTask" }, { action: "read", subject: "TechTask" }], isSidebar: false }
        ], subMenu: true
      },
      { name: "consumption", filter: true, addButton: false, addButtonText: "create", isVisible: true, path: "/equipment/consumption/rate", component: ConsumptionRate, permissions: [{ action: "manage", subject: "Incident" }, { action: "update", subject: "Incident" }], isSidebar: true, subNav: [], isHr: true },
      { titleName: "from", name: "equipmentFailure", filter: true, addButton: true, addButtonText: "fix", isVisible: true, path: "/equipment/failure", component: EquipmentFailure, permissions: [{ action: "manage", subject: "Incident" }, { action: "create", subject: "Incident" }, { action: "read", subject: "Incident" }, { action: "update", subject: "Incident" }], isSidebar: true, subNav: [], isHr: true },
      { titleName: "", name: "replacing", filter: false, addButton: false, addButtonText: "fix", isVisible: true, path: "/equipment/replacing/programs", component: Default, permissions: [{ action: "hide", subject: "Incident" }], isSidebar: true, subNav: [] },
    ],
    component: Default,
    isSidebar: true,
  ...
  },
  {
    ...
    subNavHeading: "",
    subNav: [
      { name: "ware", filter: true, addButton: true, addButtonText: "create", isVisible: true, path: "/warehouse/create", component: Warehouse, permissions: [{ action: "manage", subject: "Warehouse" }, { action: "read", subject: "Warehouse" }, { action: "update", subject: "Warehouse" }], isSidebar: true, subNav: [], subMenu: false, isImport: true },
      ...
      { name: "groups", filter: false, addButton: true, addButtonText: "create", isVisible: true, path: "/warehouse/inventoryGroups", component: InventoryGroups, permissions: [{ action: "manage", subject: "Warehouse" }, { action: "read", subject: "Warehouse" }, { action: "update", subject: "Warehouse" }], isSidebar: true, subNav: [], subMenu: false },
      { name: "documents", filter: true, addButton: true, addButtonText: "createDo", isVisible: true, path: "/warehouse/documents", component: Documents, permissions: [{ action: "manage", subject: "Warehouse" }, { action: "read", subject: "Warehouse" }, { action: "create", subject: "Warehouse" }], isSidebar: true, subNav: [], subMenu: false },
      { name: "createDo", filter: false, addButton: false, addButtonText: "create", isVisible: true, path: "/warehouse/documents/creation", component: DocumentsCreation, permissions: [{ action: "manage", subject: "Warehouse" }, { action: "read", subject: "Warehouse" }, { action: "create", subject: "Warehouse" }], isSidebar: false, subNav: [], subMenu: false },
      { name: "createDo", filter: false, addButton: true, addButtonText: "edit", isVisible: true, path: "/warehouse/documents/view", component: DocumentView, permissions: [{ action: "manage", subject: "Warehouse" }, { action: "read", subject: "Warehouse" }, { action: "create", subject: "Warehouse" }], isSidebar: false, subNav: [], subMenu: false },
      { name: "left", filter: true, addButton: false, addButtonText: "create", isVisible: true, path: "/warehouse/leftovers", component: OverheadCosts, permissions: [{ action: "manage", subject: "Warehouse" }, { action: "read", subject: "Warehouse" }], isSidebar: true, subNav: [], subMenu: false },
      { name: "suppliers", filter: true, addButton: true, addButtonText: "create", isVisible: true, path: "/warehouse/suppliers", component: Suppliers, permissions: [{ action: "manage", subject: "Warehouse" }, { action: "read", subject: "Warehouse" }, { action: "update", subject: "Warehouse" }], isSidebar: true, subNav: [], subMenu: false },
    ],
